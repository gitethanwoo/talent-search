...
export function ChatPanel({ isOpen, onToggle }: ChatPanelProps) {
  ...
  return (
    <div className="fixed top-0 right-0 bottom-0 w-[420px] bg-zinc-950 border-l border-zinc-800 z-50 flex flex-col">
        ...
        {/* Input */}
        <div className="flex-shrink-0 border-t border-zinc-800 p-5">
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-2 bottom-2 p-2 text-zinc-500 hover:text-amber-400 disabled:opacity-30 disabled:hover:text-zinc-500 transition-colors"
            >
